...
def main():
    linker_map_path = 'build_vbcc/ROM.map'  # Replace with your linker map file path
    output_script_path = 'build_vbcc/mame_debugger_script_vbcc.txt'  # Replace with desired output script path
